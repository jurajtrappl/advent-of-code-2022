...
handshape_scores = {HandShape.ROCK.value: 1,
                    HandShape.PAPER.value: 2, HandShape.SCISSORS.value: 3}
...
def first_part_guide(opponent_handshape: str, my_handshape: str) -> int:
    guide = {'X': HandShape.ROCK.value,
             'Y': HandShape.PAPER.value, 'Z': HandShape.SCISSORS.value}
    ...
    rock_loss = opponent_handshape == HandShape.PAPER.value and guide[
        my_handshape] == HandShape.ROCK.value
    scissors_loss = opponent_handshape == HandShape.ROCK.value and guide[
        my_handshape] == HandShape.SCISSORS.value
    paper_loss = opponent_handshape == HandShape.SCISSORS.value and guide[
        my_handshape] == HandShape.PAPER.value
